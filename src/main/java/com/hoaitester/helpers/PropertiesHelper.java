...
//        files.add("src/test/resources/configs/production.properties");
    ...
    public static void setValue(String key, String keyValue) {
        ...
        //src/test/resources/configs/data.properties
    }
    public static void setValue1(String key, String keyValue, String filePath) {
        try {
            if (file == null) {
                properties = new Properties();
                file = new FileInputStream(SystemHelper.getCurrentDir() + filePath);
                properties.load(file);
                file.close();
